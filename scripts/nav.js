const GITHUB_URL = "https://github.com/ieVictor"
const LINKEDIN_URL = "https://www.linkedin.com/in/victor-gabriel-l/"
...
function buildNav() {
  ...
  if (document.querySelector("main#hero")) {
    nav.classList.add("site-nav--hero")
  }

  nav.innerHTML = `
    <div class="site-nav__inner">
      <a class="site-nav__brand" href="./index.html">ievictor.sh</a>
      <div class="site-nav__links">
        <a href="${GITHUB_URL}" target="_blank" rel="noopener" aria-label="GitHub">${ICONS.github}</a>
        <a href="${LINKEDIN_URL}" target="_blank" rel="noopener" aria-label="LinkedIn">${ICONS.linkedin}</a>
